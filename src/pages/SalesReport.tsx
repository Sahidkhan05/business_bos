...
import { salesService, type SalesAnalytics, type TopCustomer, type TopProduct, type PaymentTypeDistribution, type RevenueByDate } from '../services/salesService';
...
const SalesReport: React.FC = () => {
    ...
    const loadSalesData = async () => {
        ...
        try {
            ...
            const [analyticsData, topCustomersData, topProductsData, paymentDistData, revenueData, billsData] = await Promise.all([
